...
3. **Name:** MyWebserver
4. **OS Image:** Amazon Linux 2023 (Free Tier eligible).
...
2. Install Apache: `sudo yum install -y httpd`
3. Start Apache service: `sudo systemctl start httpd`
4. Enable Apache to start on boot: `sudo systemctl enable httpd`
